...
\begin{hint}
 Using the first pivot (the num­ ber 2 in the upper left corner of A), we subtract three times the first row from the second row to get:     The matrix is  [['2','3','5'],['0', '6'],'-3']]
\end{hint}
